...
EXPECTED_ALL = {
    "SCHEMA", "CircuitV0Error", "LabCircuit", "RunResult", "View",
    "load_circuit", "run_circuit", "sample_circuit",
    "scan_circuit", "fidelity_sweep", "translate_v0",
}
...
def test_ir_no_longer_defines_build_result():
    ...
    assert not hasattr(ir, "_meters"), (
        "ir.py must not define _meters (moved to gaussian_backend)"
    )
...
def test_ir_no_private_backend_reexports():
    ...
    import cvsim.lab.ir as ir
    dead = {"_fock_meters", "_bosonic_meters", "_LEAKAGE_DIM_CAP", "_fidelity_target",
            "_fock_joint", "_fock_leakage", "_fock_mean_photon", "_fock_measured",
            "_fock_mode_probs", "_fock_purity", "_fock_wigner",
            "_bosonic_adaptive_n", "_bosonic_reduce_to_mode",
            "_bosonic_single_wigner", "_bosonic_wigner_payload"}
