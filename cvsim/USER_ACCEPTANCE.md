...
> 版本锚点：pytest **117** passed（切片后请改本数）。
...
已落地（见 U7–U9 + P1 A/B + β G5 + γ）：G/B Homodyne sample + **sample_and_condition**；B condition；Fock **1–2 模 loss→ρ** + **1 模 ρ 门** + **S₂** + **Homodyne mean/var/sample**；**Wigner G+B+F**；GKP **`gkp0`/`gkp1`** + nn cross；G/B **`loss(..., nbar)`**。
