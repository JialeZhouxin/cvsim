...
#: rejected.
#: cutoff/initial: Fock per-mode cutoffs + number-state initial (F3/F7);
#: backend: representation selector (F7, ignored on the Gaussian path).
...
# copies that drifted apart; the private aliases keep this module's call
# sites (and the historical names) intact.
_is_num = is_num
