...
**版本**: 0.2
**最后更新**: 2026-08-14（Schema 精简：3 档深度 / 3 来源标记 / 7 偏好字段，见设计修订）
...
| 结构映射四问（流水线/表示/直觉/对账） | 深 | Observed | 2026-08-13 |
...
| 表达触发型：跳过直觉直接上公式/术语时容易丢失 | 浅 | Inferred（反模式清单 §3.2 用户锁定 5 条反模式，说明此类表达曾造成卡顿） | 回答时先直觉后公式 |
