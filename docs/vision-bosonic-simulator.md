...
**Status:** Vision locked by grill (Q1–Q13, 2026-08-13); **B0–B2 done (2026-08-17)**：基线冻结 + 能力完备（门全集/通道/heterodyne+threshold/coherent 工厂/BOSONIC_PUBLIC 冻结 38 名）+ 组件工程（merge/truncate/underflow/normalize + LeakReport + is_hermitian，phaseB2 marker）；B3 测量精度 next
